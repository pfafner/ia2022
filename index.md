...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                                    | **Recursos**
  ...
  23       | 21.04.2022   | Clasificadores lineales. El clasificador logístico. <br/> [Aula 22](aulas/Aula22_notas.pdf){:target="_blank"} | [logistic.ipynb](code/logistic.ipynb){:target="_blank"} 
