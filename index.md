...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                                    | **Recursos**
  ...
  06       | 03.02.2022   | Algoritmos ruta más corta: Dijkstra, Bellman-Ford, Floyd-Warshall. <br/> Algoritmos árbol de expansión mínima: Prim-Jarník, Kruskal. | Simulación de Algoritmos *shortest path* <br/> [cmps-people.ok.ubc.ca/ylucet/DS/Dijkstra.html](https://cmps-people.ok.ubc.ca/ylucet/DS/Dijkstra.html){:target="_blank"}
