...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                                    | **Recursos**
  ...
  11       | 22.02.2022   | Otros métodos de descenso. Descenso gradiente estocástico. <br/> [Aula 11 notas](aulas/Aula11_notas.pdf){:target="_blank"} | Métodos de gradiente estocástico <br/>
 [ruder.io](https://ruder.io/optimizing-gradient-descent/){:target="_blank"} <br/>
