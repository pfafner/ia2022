...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                                    | **Recursos**
  ...
  05       | 01.02.2022   | Estrategias de Búsqueda: BFS, DFS, Greedy, Backtracking. <br/>  | Simulación de Algoritmos *shortest path* <br/> [visualgo.net/en/sssp](https://visualgo.net/en/sssp){:target="_blank"}
